                                ...
                                <table class="table table-bordered text-nowrap border-bottom" id="datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="bg-transparent border-bottom-0 wp-15">Size</th>
                                            <th class="bg-transparent border-bottom-0 wp-15">Color</th>
                                            <th class="bg-transparent border-bottom-0 wp-15">Cloth For</th>
                                            <th class="bg-transparent border-bottom-0 wp-15">Condition</th>
