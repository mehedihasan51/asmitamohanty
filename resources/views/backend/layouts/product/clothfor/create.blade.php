@extends('backend.app', ['title' => 'Cteate Cloth For'])
                        ...
                        <div class="tab-pane active show" id="editProfile">
                            <div class="card">
                                <div class="card-body border-0">
                                    <form class="form-horizontal" method="post" action="{{ route('admin.product.clothfor.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row mb-4">
