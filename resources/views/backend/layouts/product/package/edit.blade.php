                        ...
                        <div class="tab-pane active show" id="editProfile">
                            <div class="card">
                                <div class="card-body border-0">
                                    <form class="form-horizontal" method="POST" action="{{ route('admin.product.package.update', $package->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row mb-4">
                                        ...
                                        <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Enter here name" id="name" value="{{ $package->name ?? old('name') ?? '' }}">
                                                        @error('name')
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control @error('day') is-invalid @enderror" name="day" placeholder="Enter here day" id="day" value="{{ $package->day ?? old('day') ?? '' }}">
                                                        @error('day')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control @error('price_per_day') is-invalid @enderror" name="price_per_day" placeholder="Enter here price per day" id="price_per_day" value="{{ $package->price_per_day ?? old('price_per_day') ?? '' }}">
                                                        @error('price_per_day')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
