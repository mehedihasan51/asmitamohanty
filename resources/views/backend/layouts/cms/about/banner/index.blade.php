@extends('backend.app', ['title' => 'about Banner'])
    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">CMS : about Banner</h1>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.cms.about.banner.content') }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                ...
                <div class="col-md-7">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between border-bottom">
                            <h3 class="card-title">All about Banner Items</h3>
                            <!-- Add New Page Button -->
                            <a href="{{route('admin.cms.about.banner.create')}}" class="btn btn-primary">
...
<script>
    $(document).ready(function() {
        ...
        if (!$.fn.DataTable.isDataTable('#datatable')) {
            let dTable = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.cms.about.banner.index') }}",
                    type: "GET",
                },
    ...
    function statusChange(id) {
        let url = "{{ route('admin.cms.about.banner.status', ':id') }}";
        $.ajax({
            type: "GET",
    ...
    function deleteItem(id) {
        let url = "{{ route('admin.cms.about.banner.destroy', ':id') }}";
    ...
    function editItem(id) {
        event.preventDefault();
        let url = "{{ route('admin.cms.about.banner.edit', ':id') }}";
        window.location.href = url.replace(':id', id);
    }

    function goToShow(id) {
        event.preventDefault();
        let url = "{{ route('admin.cms.about.banner.show', ':id') }}";
        window.location.href = url.replace(':id', id);
    }
</script>
@endpush