            ...
            <ul class="side-menu mt-2">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('admin.product.size.index') }}" class="slide-item">Product Size</a></li>
                        <li><a href="{{ route('admin.product.condition.index') }}" class="slide-item">Product Condition</a></li>
                        <li><a href="{{ route('admin.product.clothfor.index') }}" class="slide-item">Product Cloth For</a></li>
                        <li><a href="{{ route('admin.product.color.index') }}" class="slide-item">Product Color</a></li>
                        <li><a href="{{ route('admin.product.measurement.index') }}" class="slide-item">Product Measurement</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item {{  request()->routeIs('booking') ? 'has-link' : '' }}" href="{{ route('admin.booking.index') }}">
                        <i class="fa-solid fa-credit-card side-menu__icon"></i>
                        <span class="side-menu__label">Booking History</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item {{  request()->routeIs('category') ? 'has-link' : '' }}" href="{{ route('admin.category.index') }}">
                        ...
                        <span class="side-menu__label">Category (collection)</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item {{  request()->routeIs('transaction') ? 'has-link' : '' }}" href="{{ route('admin.transaction.index') }}">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">About Page</span><i class="angle fa fa-angle-right"></i>
                    </a>

                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.about.banner.index') }}" class="slide-item">Banner Section</a></li>
                        {{-- <li><a href="{{ route('admin.cms.home.hero.index') }}" class="slide-item">Hero Section</a></li> --}}
                    </ul>
                </li>
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.setting.term.index') }}" class="slide-item">Terms and Conditions</a></li>
                        <li><a href="{{ route('admin.cms.setting.privacy.index') }}" class="slide-item">Privacy Policy</a></li>
                    </ul>
                </li>
            </ul>
