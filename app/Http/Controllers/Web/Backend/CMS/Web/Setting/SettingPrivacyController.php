...
namespace App\Http\Controllers\Web\Backend\CMS\Web\Setting;
...
class SettingPrivacyController extends Controller
{
    ...
    public $page = PageEnum::SETTING;
    public $item = SectionEnum::PRIVACY;
    public $items = SectionEnum::PRIVACIES;
    public $count = 3;
