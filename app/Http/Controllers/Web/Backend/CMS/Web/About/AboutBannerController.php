...
class AboutBannerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view("backend.layouts.cms.about.{$this->section}.index", compact('section'));
    }
    ...
    {
        return view("backend.layouts.cms.about.{$this->section}.create");
    }
    ...
    public function store(CmsRequest $request)
    {
        ...
        try {
            ...
            return redirect()->route("admin.cms.about.{$this->section}.index")->with('t-success', 'Created successfully');
        } catch (Exception $e) {
    ...
    public function show(string $id)
    {
        ...
        return view("backend.layouts.cms.about.{$this->section}.update", compact("section"));
    }
    ...
    public function update(CmsRequest $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route("admin.cms.about.{$this->section}.index")->with('t-success', 'Updated successfully');
        } catch (Exception $e) {
            return redirect()->back()->with('t-error', $e->getMessage());
        }
    }
