            ...
            return DataTables::of($data)
                ...
                ->addColumn('image', function ($data) {
                    if ($data->image) {
                        ...
                        return '<img src="' . $url . '" alt="image" width="50px" height="50px" style="margin: 0 auto; display: block;">';
                    } else {
                        return '<img src="' . asset('default/logo.png') . '" alt="image" width="50px" height="50px" style="margin: 0 auto; display: block;">';
                    }
                })
